    ...
    <section class="grid gap-6 lg:grid-cols-[1fr_360px]">
        <div class="rounded-2xl border border-gaz-border bg-gaz-card p-6">
            ...
            <div class="mt-6 flex flex-wrap gap-3">
                ...
                @else
                    <div class="rounded-xl border border-red-500/30 bg-red-500/10 px-4 py-3 text-sm font-bold text-red-200">Nomor WhatsApp pelanggan belum valid.</div>
                @endif
        ...
        <aside class="h-fit rounded-2xl border border-yellow-500/30 bg-yellow-500/10 p-5 text-yellow-100">
            ...
            <div class="mt-4 border-t border-yellow-500/20 pt-4 text-sm">
                ...
                <p class="mt-1"><span class="font-bold">No. HP:</span> {{ $whatsappPhone ? '+'.$whatsappPhone : '-' }}</p>
